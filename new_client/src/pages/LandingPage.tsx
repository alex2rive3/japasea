import { Box, Button, Chip, Container, Stack, Typography, Card, CardContent } from '@mui/material';
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 6, md: 10 } }}>
        <Box sx={{
          ...
          {[
            ...
            <Card variant="outlined" sx={{ height: '100%', borderRadius: 3 }} key={titleKey}>
              <CardContent>
                <Stack spacing={1.2}>
                  <Box>{icon}</Box>
        ...
        <Container maxWidth="lg">
          <Box sx={{
            ...
            {[
              ...
              <Stack spacing={0.5} alignItems="center" key={labelKey}>
